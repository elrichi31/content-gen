...
assert.deepEqual(result, { value: { ok: true }, model: "script-test", usage: { output_tokens: 2 }, sources: [] }, "devuelve valor, modelo, uso disponible y fuentes web (vacías sin búsqueda)");
